Feature:
  ...
  Scenario: Manager approves a report
    Given I one of my employees has their objectives set
  ...
  Scenario: Manager approves mid-year progress
    Given I one of my employees has their mid-year review filled
  ...
  Scenario: Manager approves end-year progress
    Given I one of my employees has their end-year review filled
